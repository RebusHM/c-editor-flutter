...
class ZombossMechBattleModuleData extends PvzModel {
  ZombossMechBattleModuleData({
  ...
  factory ZombossMechBattleModuleData.fromJson(Map<String, dynamic> json) {
    return ZombossMechBattleModuleData(
